    ...
    <AppLayout>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Meet</h1>
          <p className="text-gray-600 dark:text-gray-400">Start or join video meetings instantly</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">New Meeting</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Start an instant video meeting</p>
            <button
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Join Meeting</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Enter a meeting code to join</p>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2.5 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Plan a meeting for later</p>
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-12 text-center shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">Start your first meeting or schedule one for later</p>
          </div>
        ) : (
              ...
              <div>
                ...
                <div className="space-y-3">
                  {upcomingMeetings.map((meeting) => (
                    <div key={meeting._id} className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-between">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {recentMeetings.slice(0, 5).map((meeting) => (
                    <div key={meeting._id} className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-between opacity-75">
                      <div className="flex items-center gap-4">
