  ...
  return (
    <AppLayout>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {accounts.length > 0 && (
          <div className="mb-6">
            ...
            <select
              ...
              className="w-full md:w-64 px-4 py-2 bg-white dark:bg-white border border-gray-200 dark:border-gray-200 rounded-lg"
            >
        ...
        {/* No Accounts Warning */}
        {accounts.length === 0 && (
          <div className="bg-white dark:bg-white rounded-2xl p-8 text-center border border-gray-200 dark:border-gray-200 mb-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-purple-600 text-gray-900 rounded-lg font-medium"
            >
              ...
              {AUTOMATION_TYPES.map(type => {
                ...
                return (
                  <button
                    ...
                    className="bg-white dark:bg-white rounded-xl p-4 border border-gray-200 dark:border-gray-200 text-left hover:shadow-md transition group"
                  >
                    <div className={`w-12 h-12 rounded-xl ${colorClasses[type.color]} flex items-center justify-center mb-3`}>
                      <type.icon className="w-6 h-6" />
                    </div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-900 group-hover:text-purple-600">
                      {type.name}
                    </h3>
        ...
        {/* Rate Limits Info */}
        <div className="mt-8 bg-gray-50 dark:bg-white/50 rounded-xl p-4 border border-gray-200 dark:border-gray-200">
          <h3 className="font-semibold text-gray-900 dark:text-gray-900 flex items-center gap-2 mb-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-gray-900">30 max</p>
            </div>
            <div>
              <p className="text-gray-500">Comments/Hour</p>
              <p className="font-medium text-gray-900 dark:text-gray-900">20 max</p>
            </div>
            <div>
              <p className="text-gray-500">Follows/Day</p>
              <p className="font-medium text-gray-900 dark:text-gray-900">50 max</p>
            </div>
            <div>
              <p className="text-gray-500">Messages/Hour</p>
              <p className="font-medium text-gray-900 dark:text-gray-900">15 max</p>
            </div>
          </div>
        </div>
      </div>
...
function CreateAutomationModal({ type, account, onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/50 flex items-end sm:items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-white rounded-t-2xl sm:rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button onClick={onClose} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-100 rounded-lg">
              ×
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <>
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-gray-200 dark:border-gray-200 rounded-lg bg-white dark:bg-white"
                  >
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 py-3 border border-gray-200 dark:border-gray-200 rounded-lg font-medium"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-3 bg-purple-600 text-gray-900 rounded-lg font-medium disabled:opacity-50"
              >
