      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-900">Social Accounts</h1>
            <p className="text-gray-600 dark:text-gray-500">Manage your connected social media accounts</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-white rounded-xl p-12 text-center shadow-sm border border-gray-100 dark:border-gray-200">
            ...
            <p className="text-gray-500 dark:text-gray-500 mb-6">Add your social media accounts to start automating</p>
            <button
              onClick={() => setShowModal(true)}
          ...
          <div className="space-y-4">
            {accounts.map(account => (
              <div
                key={account._id}
                className="bg-white dark:bg-white rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-200 flex items-center justify-between"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-900">{account.email}</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-500 capitalize">{account.platform}</p>
                  </div>
                </div>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-gray-900/50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-white rounded-xl w-full max-w-md">
              <div className="p-6 border-b border-gray-100 dark:border-gray-200">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900">Add Social Account</h2>
              </div>
              ...
              <form onSubmit={addAccount} className="p-6">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-600 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-gray-600"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={adding}
                    className="flex-1 py-3 bg-purple-600 text-gray-900 rounded-lg font-medium hover:bg-purple-700 disabled:opacity-50 flex items-center justify-center gap-2"
                  >
