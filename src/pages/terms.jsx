          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-10">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">4.1 Your Content</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">4.2 Content Standards</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">You agree not to post User Content that:</p>
                <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3 mt-4">4.3 Content Moderation</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">7. AI-Generated Content</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">8. Live Streaming</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">9. Third-Party Services</h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">10. Disclaimers</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">11. Limitation of Liability</h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">12. Indemnification</h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">13. Termination</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">14. Governing Law</h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">15. Changes to Terms</h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">16. Severability</h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">17. Entire Agreement</h2>
                <p className="text-gray-600 dark:text-gray-300">
