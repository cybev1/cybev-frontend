  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
        {/* Header */}
        <header className="bg-white dark:bg-gray-50 border-b border-gray-200 dark:border-gray-200 sticky top-0 z-40">
        ...
        <main className="max-w-7xl mx-auto px-4 py-6">
          {/* Filters */}
          <div className="bg-white dark:bg-gray-50 rounded-2xl p-4 mb-6 border border-gray-100 dark:border-gray-200">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-white border border-gray-200 dark:border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500"
                />
              </div>
              ...
              <select
                ...
                className="px-4 py-2.5 bg-gray-50 dark:bg-white border border-gray-200 dark:border-gray-200 rounded-xl"
              >
          ...
          {/* Users Table */}
          <div className="bg-white dark:bg-gray-50 rounded-2xl border border-gray-100 dark:border-gray-200 overflow-hidden">
            {loading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-100">
                    {users.map((user) => (
                      <tr key={user._id} className="hover:bg-gray-50 dark:hover:bg-gray-50/50">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            />
                            <div>
                              <p className="font-medium text-gray-900 dark:text-gray-900 flex items-center gap-1">
                                {user.name}
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-500">{user.email}</td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4 text-right relative">
                          ...
                          {showActions === user._id && (
                            <div className="absolute right-6 top-full mt-1 w-48 bg-white dark:bg-white rounded-xl shadow-lg border border-gray-200 dark:border-gray-200 py-2 z-50">
                              <Link href={`/profile/${user.username}`}>
                                <button className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-100 flex items-center gap-2">
                              ...
                              {!user.isVerified && (
                                <button
                                  ...
                                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-100 flex items-center gap-2 text-blue-600"
                                >
                              ...
                              {user.role !== 'admin' && (
                                <button
                                  ...
                                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-100 flex items-center gap-2 text-purple-600"
                                >
                              ...
                              {user.role !== 'moderator' && user.role !== 'admin' && (
                                <button
                                  ...
                                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-100 flex items-center gap-2 text-orange-600"
                                >
                              ...
                              {(user.role === 'admin' || user.role === 'moderator') && (
                                <button
                                  ...
                                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-100 flex items-center gap-2 text-gray-600"
                                >
                                  <UserX className="w-4 h-4" /> Remove Role
                                </button>
                              )}

                              <div className="border-t border-gray-200 dark:border-gray-200 my-1" />

                              {user.isBanned ? (
                                <button
                                  onClick={() => handleAction('unban', user._id)}
                                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-100 flex items-center gap-2 text-green-600"
                                >
                                ...
                                <button
                                  ...
                                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-100 flex items-center gap-2 text-red-600"
                                >
          ...
          {pagination.pages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-6">
              <button
                ...
                disabled={page === 1}
                className="px-4 py-2 bg-white dark:bg-white border border-gray-200 dark:border-gray-200 rounded-lg disabled:opacity-50 flex items-center gap-1"
              >
                    ...
                    <button
                      ...
                      className={`w-10 h-10 rounded-lg ${
                        page === pageNum
                          ...
                          : 'bg-white dark:bg-white border border-gray-200 dark:border-gray-200'
                      }`}
                    >
                      {pageNum}
                    </button>
