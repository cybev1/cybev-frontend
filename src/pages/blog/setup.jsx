...
export default function BlogSetup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-gray-900">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="px-4 py-2 rounded-lg border border-gray-200 hover:border-gray-500"
            >
              Preview
            </Link>
            <button
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-gray-200 bg-gray-900/40 p-5">
            ...
            <input
              ...
              className="w-full rounded-lg bg-gray-900 border border-gray-200 px-3 py-2"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 rounded-lg bg-gray-900 border border-gray-200 px-2"
                />
              </div>
            </div>
            ...
            <textarea
              ...
              className="w-full rounded-lg bg-gray-900 border border-gray-200 px-3 py-2 min-h-[90px]"
          ...
          <div className="rounded-2xl border border-gray-200 bg-gray-900/40 p-5">
            ...
            <label className="block text-sm text-gray-600 mb-1">Selected template ID</label>
            <input
              value={templateId}
          ...
          <div className="rounded-2xl border border-gray-200 bg-gray-900/40 p-5">
            ...
            <label className="block text-sm text-gray-600 mb-1">Custom domain</label>
            <input
              value={customDomain}
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <Link
              href="/blog/create"
              className="px-5 py-3 rounded-xl border border-gray-200 hover:border-gray-500 text-center"
            >
