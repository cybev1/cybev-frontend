...
export default function PracticallivingPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Practical Living Blog</h1>
      <p className="text-gray-600">Finance, food, gardening, fashion — real life, real skills.</p>
