...
export default function SocietyworldviewPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Society & Worldview Blog</h1>
      <p className="text-gray-600">Dive into culture, politics, religion, and social transformation.</p>
