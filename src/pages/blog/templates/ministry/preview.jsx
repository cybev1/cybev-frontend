...
export default function MinistryPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Ministry Blog</h1>
      <p className="text-gray-600">For evangelists, missionaries, and ministry leaders to reach the world.</p>
