...
export default function NewsblogcnnPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">News Blog (CNN Style)</h1>
      <p className="text-gray-600">Breaking stories, categories, and a strong homepage layout.</p>
