...
export default function MagazinePreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Magazine Blog</h1>
      <p className="text-gray-600">Visually engaging layout for online magazines and publishers.</p>
