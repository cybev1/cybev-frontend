...
export default function SciencetechPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Science & Tech Blog</h1>
      <p className="text-gray-600">Explore AI, space, robotics, physics, and modern discoveries.</p>
