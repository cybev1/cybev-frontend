...
export default function ArtscreativityPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Arts & Creativity Blog</h1>
      <p className="text-gray-600">Showcase your creative talents — from visual arts to performance, DIY, and literature.</p>
