...
export default function EducationlearningPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Education & Learning Blog</h1>
      <p className="text-gray-600">For educators, learners, and knowledge seekers — tutorials, ideas, and guides.</p>
