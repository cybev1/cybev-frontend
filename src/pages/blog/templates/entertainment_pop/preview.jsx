...
export default function EntertainmentpopPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Entertainment & Pop Culture Blog</h1>
      <p className="text-gray-600">Cover trending shows, celebrity updates, music, and fan theories.</p>
