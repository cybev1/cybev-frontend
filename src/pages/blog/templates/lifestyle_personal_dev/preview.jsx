...
export default function LifestylepersonaldevPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Lifestyle & Personal Growth Blog</h1>
      <p className="text-gray-600">Inspire others with habits, routines, travel logs, and relationship tips.</p>
