...
export default function ChurchPreview() {
  return (
    <div className="p-6 space-y-6 bg-white">
      <h1 className="text-3xl font-bold text-gray-900">Church Blog</h1>
      <p className="text-gray-600">Designed for local churches to share sermons, events, and prayer requests.</p>
