        ...
        <header className="bg-white dark:bg-white border-b border-gray-200 dark:border-gray-200 sticky top-0 z-10">
          <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-gray-900 dark:text-gray-900">Privacy Policy</h1>
            </div>
          </div>
        </header>
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white dark:bg-white rounded-2xl border border-gray-200 dark:border-gray-200 p-6 md:p-10">
            ...
            <div className="mb-8 pb-6 border-b border-gray-200 dark:border-gray-200">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-900 mb-2">Privacy Policy</h1>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">1. Introduction</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">2. Information We Collect</h2>
                
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-700 mb-3">2.1 Information You Provide</h3>
                <ul className="list-disc pl-6 text-gray-600 dark:text-gray-600 mb-4 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-700 mb-3">2.2 Information Collected Automatically</h3>
                <ul className="list-disc pl-6 text-gray-600 dark:text-gray-600 mb-4 space-y-2">
                ...
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-700 mb-3">2.3 Information from Third Parties</h3>
                <p className="text-gray-600 dark:text-gray-600">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">3. How We Use Your Information</h2>
                <p className="text-gray-600 dark:text-gray-600 mb-4">We use the information we collect to:</p>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">4. Sharing Your Information</h2>
                <p className="text-gray-600 dark:text-gray-600 mb-4">We may share your information in the following circumstances:</p>
                <ul className="list-disc pl-6 text-gray-600 dark:text-gray-600 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">5. Data Security</h2>
                <p className="text-gray-600 dark:text-gray-600">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">6. Data Retention</h2>
                <p className="text-gray-600 dark:text-gray-600">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">7. Your Rights and Choices</h2>
                <p className="text-gray-600 dark:text-gray-600 mb-4">You have the following rights regarding your personal information:</p>
                <ul className="list-disc pl-6 text-gray-600 dark:text-gray-600 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">8. Children's Privacy</h2>
                <p className="text-gray-600 dark:text-gray-600">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">9. International Data Transfers</h2>
                <p className="text-gray-600 dark:text-gray-600">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">10. Third-Party Links</h2>
                <p className="text-gray-600 dark:text-gray-600">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">11. Changes to This Policy</h2>
                <p className="text-gray-600 dark:text-gray-600">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-4">12. Contact Us</h2>
                <p className="text-gray-600 dark:text-gray-600 mb-4">
