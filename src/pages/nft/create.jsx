  ...
  return (
    <div className="flex gap-2 items-center">
      <input
        ...
        className="flex-1 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm focus:border-purple-500 focus:outline-none"
      />
      <input
        type="text"
        placeholder="Value"
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400">Mint your unique digital asset on Polygon</p>
          </div>
        </div>
        ...
        <div className="flex justify-between text-sm text-gray-400 mb-8">
          <span className={step === 1 ? 'text-purple-400' : ''}>Upload</span>
          <span className={step === 2 ? 'text-purple-400' : ''}>Details</span>
          <span className={step === 3 ? 'text-purple-400' : ''}>Pricing</span>
        ...
        {step === 1 && (
          <div className="space-y-6">
            ...
            >
              {uploading ? (
                ...
                <>
                  ...
                  <p className="text-white text-lg mb-2">Upload your file</p>
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              Continue
            </button>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-gray-800 border rounded-xl px-4 py-3 text-white focus:border-purple-500 focus:outline-none ${
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={nextStep}
                className="flex-1 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-medium hover:opacity-90 transition-opacity"
              >
                Continue
              </button>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 border border-purple-500/20">
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <p className="text-white font-medium">List for Sale</p>
                  <p className="text-gray-400 text-sm">Put this NFT up for sale immediately</p>
                </div>
                <div
            ...
            {formData.isListed && (
              <>
                {/* Listing Type */}
                <div>
                  <label className="block text-white font-medium mb-2">Sale Type</label>
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <DollarSign className={`w-6 h-6 mx-auto mb-2 ${
                        formData.listingType === 'fixed' ? 'text-purple-400' : 'text-gray-400'
                      }`} />
                      <p className="text-white font-medium">Fixed Price</p>
                      <p className="text-gray-400 text-xs">Sell at a set price</p>
                    </button>
                    <button
                    ...
                    >
                      <Clock className={`w-6 h-6 mx-auto mb-2 ${
                        formData.listingType === 'auction' ? 'text-purple-400' : 'text-gray-400'
                      }`} />
                      <p className="text-white font-medium">Timed Auction</p>
                      <p className="text-gray-400 text-xs">Auction to highest bidder</p>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0"
                      className={`w-full bg-gray-800 border rounded-xl px-4 py-3 pr-20 text-white focus:border-purple-500 focus:outline-none ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 pr-12 text-white focus:border-purple-500 focus:outline-none"
                />
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 border border-purple-500/20">
              <label className="flex items-center justify-between cursor-pointer mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">Unlockable Content</p>
                    <p className="text-gray-400 text-sm">Include content only visible to the owner</p>
                  </div>
                </div>
                <div
              ...
              {formData.hasUnlockable && (
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-gray-700 border border-gray-600 rounded-xl px-4 py-3 text-white focus:border-purple-500 focus:outline-none resize-none"
                />
              )}
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800/50 rounded-2xl p-6 border border-purple-500/20">
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  <h2 className="text-2xl font-bold text-white mb-2">{formData.name || 'Untitled'}</h2>
                  <p className="text-gray-400 mb-4">{formData.description || 'No description'}</p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {formData.isListed && (
                      <>
                        <div>
                          <p className="text-gray-400 text-sm">Sale Type</p>
                          <p className="text-white capitalize">{formData.listingType}</p>
                        </div>
                        <div>
                          <p className="text-gray-400 text-sm">Price</p>
                          <p className="text-white font-bold">{formData.listingPrice} CYBEV</p>
                        </div>
                      </>
                    )}
                  </div>
              ...
              {formData.attributes.filter(a => a.trait_type && a.value).length > 0 && (
                <div className="mt-6 pt-6 border-t border-gray-700">
                  <p className="text-gray-400 text-sm mb-3">Properties</p>
                  <div className="flex flex-wrap gap-2">
                    {formData.attributes.filter(a => a.trait_type && a.value).map((attr, i) => (
                      <div key={i} className="bg-purple-500/20 rounded-lg px-3 py-2">
                        <p className="text-purple-400 text-xs">{attr.trait_type}</p>
              ...
              {/* Unlockable */}
              {formData.hasUnlockable && (
                <div className="mt-6 pt-6 border-t border-gray-700 flex items-center gap-2 text-purple-400">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                disabled={loading}
                className="flex-1 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-medium hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
