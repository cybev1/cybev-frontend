        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">My Organizations</h2>
            ...
            {organizations.length === 0 ? (
              <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center border border-gray-200 dark:border-gray-700">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">No organizations yet</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                <h3 className="font-semibold text-gray-900 dark:text-white">Recent Souls</h3>
                ...
                <div className="divide-y divide-gray-100 dark:divide-gray-700">
                  {recentSouls.map(soul => (
                    <div key={soul._id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                      <p className="font-medium text-gray-900 dark:text-white">{soul.name}</p>
