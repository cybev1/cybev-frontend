...
export default function Stories() {
  ...
  useEffect(() => {
    ...
    // Replace with dynamic user's first name when available
  ...
  return (
    <div className="py-6 space-y-6">
      ...
      >
        <div className="w-20 h-12 bg-gradient-to-br from-blue-400 to-purple-600 rounded-lg flex items-center justify-center">
          {/* Placeholder for status image or initials */}
          <span className="text-white text-xl font-bold">{greeting.split(' ')[1].charAt(0)}</span>
        </div>
        <div>
