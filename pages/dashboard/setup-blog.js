...
export default function BlogSetup() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("Simulated blog setup submission.");
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea name="description" rows="3" value={form.description}
              onChange={handleChange} placeholder="Description" className="w-full border rounded px-4 py-2" />
          </div>
          ...
          <div className="flex gap-2 items-center">
            <input name="domainValue" onChange={handleChange}
              placeholder="e.g. myblog" className="flex-1 border rounded px-4 py-2" required />
            <button type="button" onClick={handleCheckDomain}
