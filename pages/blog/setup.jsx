...
export default function BlogSetup() {
  ...
  const generateSEO = () => {
    setLoading(true);
    setTimeout(() => {
      const desc = `Unlock daily inspiration with "${form.title}" — a powerful blog sharing ${form.niche.toLowerCase()} insights rooted in ${form.category.toLowerCase()} values.`;
