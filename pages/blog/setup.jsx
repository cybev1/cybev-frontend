...
export default function BlogSetup() {
  ...
  const renderStep = () => {
    if (step === 1) return <h2 className="text-xl font-bold mb-4">Step 1: Choose Domain</h2>;
    if (step === 2) return <h2 className="text-xl font-bold mb-4">Step 2: Blog Identity</h2>;
    if (step === 3) return <h2 className="text-xl font-bold mb-4">Step 3: Select Template</h2>;
    if (step === 4) return <h2 className="text-xl font-bold mb-4">Step 4: Preview</h2>;
