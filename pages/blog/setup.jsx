...
// This is the complete version based on your last working setup.jsx
// with Step 5 updated to include a FREE HOSTING card visible to subdomain users only.
  ...
  const renderStep5 = () => {
    ...
    return (
      <>
        ...
        <p className="text-gray-600 mb-6">Choose a hosting or VPS plan for your blog, or select free hosting if you're using a subdomain.</p>
